...
The [transactional Doctrine guide](transactional-doctrine.md) documents the application-owned mapping and executable PostgreSQL proofs for shared commit, shared rollback and fail-closed behavior.
